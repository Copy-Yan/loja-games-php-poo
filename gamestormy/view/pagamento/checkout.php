...
<main id="page-payment" aria-label="Pagamento">
  ...
  <form method="POST" action="<?php echo base_url('?page=pagamento&action=processar'); ?>">
    ...
    <div class="payment-layout">
      ...
      <div class="payment-left">
        ...
        <div class="payment-block">
          ...
          <div class="pay-methods">
            <label class="pay-method-opt">
              <input type="radio" name="metodo" value="cartao" <?php echo $metodo === 'cartao' ? 'checked' : ''; ?>/>
            ...
            <label class="pay-method-opt">
              <input type="radio" name="metodo" value="pix" <?php echo $metodo === 'pix' ? 'checked' : ''; ?>/>
              <div class="pay-method-card">
            ...
            <label class="pay-method-opt">
              <input type="radio" name="metodo" value="boleto" <?php echo $metodo === 'boleto' ? 'checked' : ''; ?>/>
              <div class="pay-method-card">
        ...
        <!-- Campos do cartão -->
        <div class="payment-block" id="pay-card-fields" style="<?php echo $metodo !== 'cartao' ? 'display:none' : ''; ?>">
        ...
        <!-- Campos do boleto -->
        <div class="payment-block" id="pay-boleto-fields" style="<?php echo $metodo !== 'boleto' ? 'display:none' : ''; ?>">
          ...
          <input class="pay-input pay-input-mono" type="text" name="boleto_vencimento" placeholder="<?php echo date('d/m/Y', strtotime('+3 days')); ?>" value="<?php echo date('d/m/Y', strtotime('+3 days')); ?>"/>
        </div>

        <!-- Campos do PIX -->
        <div class="payment-block" id="pay-pix-fields" style="<?php echo $metodo !== 'pix' ? 'display:none' : ''; ?>">
        ...
        <div class="order-summary-box">
          ...
          <table class="order-table">
            ...
            <tbody>
              ...
              ?>
              <tr>
                <td class="order-product-cell"><div class="order-thumb" style="background:<?php echo htmlspecialchars($item['capa'] ?? '#555'); ?>;background-size:cover;"></div><span><?php echo htmlspecialchars(substr($item['titulo'], 0, 20)); ?></span></td>
            ...
            <tfoot>
              <tr class="order-subtotal"><td colspan="2">SUBTOTAL</td><td>R$ <?php echo number_format($subtotal, 2, ',', '.'); ?></td></tr>
              <tr class="order-total-row"><td colspan="2">TOTAL</td><td>R$ <?php echo number_format($total, 2, ',', '.'); ?></td></tr>
            </tfoot>
          </table>
        </div>

        <a href="<?php echo base_url('?page=pagamento&action=carrinho'); ?>" class="pay-back-btn">&#8592; VOLTAR AO CARRINHO</a>
