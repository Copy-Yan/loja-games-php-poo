<?php
$title = 'Pedido Confirmado - Gamestormy';
// Fallbacks para evitar warnings quando variáveis não forem injetadas.
          ...
          <tbody>
            ...
            <tr>
              <td class="confirm-product-cell">
                <div class="confirm-thumb" style="background-image:url(<?php echo htmlspecialchars($item['capa'] ?? '#555'); ?>);background-size:cover;background-position:center;"></div>
